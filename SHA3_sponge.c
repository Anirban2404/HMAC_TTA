...
// ******************************************************************************
// ** Modified by Anirban Bhattacharjee and Goncalo Martins **
// ******************************************************************************
...
//HMAC with 512-bits mac
void sponge_hmac_512(BYTE *tag, const unsigned char *key, int keylen, const unsigned char *in, int inlen )
{
	KECCAK512_DATA spng;
	...
	Sponge_finalize(&spng, tag, 64);    //optionaly permute then squeezing tag
}

static int __init init_main(void)
{
	printk(KERN_INFO "-> HMAC-SHA3 Crypto Kernel Module Loaded.\n");
...
{
	printk(KERN_INFO "-> HMAC-SHA3 Crypto Kernel Module Unloaded.\n");
}

EXPORT_SYMBOL(sha3_hmac_512);
